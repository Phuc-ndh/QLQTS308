...
namespace QuanLiQuanTraSua.Forms
{
    public partial class FormThongKe : Form
    {
        ...
        {
            dataGridViewThongKe.DataSource = BillDAO.Instance.GetBillListByDate(checkIn, checkOut);
        }
        ...
        public void TongTien()
        {
            ...
            textBoxDoanhSo.Text = thanhtien.ToString(culture);
        }
        public void TongTienKhuyenMai()
        {
            ...
            textBoxTongTien.Text = thanhtien.ToString(culture);
        }

        public void DoanhThu()
        {
            float doanhthu = 0;
             doanhthu = float.Parse(textBoxTongTien.Text) - float.Parse(textBoxDoanhSo.Text);
            textBoxDoanhThu.Text = doanhthu.ToString();
        }
